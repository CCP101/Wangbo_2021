...
//        levels[0]=new Level(1, 2, 1, 30,1, false);
//        levels[1]=new Level(2, 3, 1, 30,2,false);
//        levels[2]=new Level(3, 4, 1, 30,5, false);
//        levels[3]=new Level(4, 5, 1, 30,8, true);
//        levels[4]=new Level(5, 6, 1, 30,10, true);
//        levels[5]=new Level(6, 7, 1, 30,15, true);
    }
}
